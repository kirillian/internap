...
class Internap
	attr_accessor :internap_connection_url, :username, :password, :default_stream_location, :default_publishing_point_type, :default_secure_setting
	...
	def initialize
		...
		@internap_adaptor = InternapError.new(@internap_connection_url, @username, @password)
	...
	def create_broadcast_publishing_point(stream_name, location = @default_stream_location, publishing_point_type = @default_publishing_point_type, secure_setting = @default_secure_setting)
	...
	def remove_publishing_point(stream_name, secure_setting = @default_secure_setting)
		@internap_adaptor.remove_pub_point(stream_name, secure_setting)
	end

	def modify_publishing_point(stream_name, location = @default_stream_location, publishing_point_type = @default_publishing_point_type, secure_setting = @default_secure_setting)
	...
	private
		attr_accessor :internap_adaptor
end